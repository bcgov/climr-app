...
- If a user downscales with shape data input but selects csv output, downscale runs that have a large number of variable combinations (raster layers), converting the output to a useful csv format takes up to a couple of minutes. We are working on how to speed this up.
