...
Click on the green **Downscale Data** button. The app will downscale data for all variables available for the selected map point, so it will take time. Blue notification boxes will appear on the right-hand side of the screen as the downscaling is in progress and a plot will appear after the downscaling is complete.
