...
Please note that these plots are **not** interactive. Whenever a user makes a change to a variable, they must click the green **Generate Plot** button.
