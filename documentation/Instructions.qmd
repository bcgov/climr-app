...
In the second tab of the climr App, users can select an area of interest by Forest Landscape Plan (FLP) Areas, ecoregions of North America, or by single map points. Users can then visualize data for the selected area by available plots (Bivariate, Walter-Lieth, Time Series, Boxplot, Climate Stripes). Users can also add a climate map as an overlay on North America. For a very quick summary of functionality of this page, users can also click the *What does this page do* link at the top of the floating panel.

### **Step 1.** Select points or areas of interest:

Users can select points or areas of interest using **one of the following three methods**:

-   **Method 1**. Select **FLP Area** and click on one of the outlined areas on the map.

-   **Method 2**. Select **Ecoregion** and click on one of the outlined areas on the map.
