...
-   **Observational time-series datasets**: These datasets provide an annual sequence of climate data as observed by weather stations and other sources.
    ...
    -   **Climatic Research Unit / Global Precipitation Climatology Centre (CPU/GPCC)**: The 1901-2023 combined Climatic Research Unit TS dataset (CRU; @harris2020cruts) for temperature and Global Precipitation Climatology Centre dataset (GPCC; @becker2013gpcc) for precipitation. 
